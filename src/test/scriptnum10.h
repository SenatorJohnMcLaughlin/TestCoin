...
#ifndef TESTCOIN_TEST_SCRIPTNUM10_H
#define TESTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Testcoin Core 0.10.0, for cross-comparison.
 */
public:
