...
#ifndef TESTCOIN_QT_TESTCOINUNITS_H
#define TESTCOIN_QT_TESTCOINUNITS_H
...
public:
    ...
    /** Testcoin units.
      @note Source: https://en.testcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        TTC,
...
#endif // TESTCOIN_QT_TESTCOINUNITS_H
