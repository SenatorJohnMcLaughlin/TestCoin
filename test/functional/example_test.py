...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TestcoinTestFramework
    pass

class ExampleTest(TestcoinTestFramework):
    # Each functional test is a subclass of the TestcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        TestcoinTestFramework class so other tests can use it."""
