...
VERSION=
commit=false
url=https://github.com/testcoin/testcoin
proc=2
mem=2000
lxc=true
osslTarUrl=http://downloads.sourceforge.net/project/osslsigncode/osslsigncode/osslsigncode-1.7.1.tar.gz
osslPatchUrl=https://testcoincore.org/cfields/osslsigncode-Backports-to-1.7.1.patch
...
Run this script from the directory containing the testcoin, gitian-builder, gitian.sigs, and testcoin-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/testcoin/testcoin
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-linux --destination ../gitian.sigs/ ../testcoin/contrib/gitian-descriptors/gitian-linux.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-unsigned --destination ../gitian.sigs/ ../testcoin/contrib/gitian-descriptors/gitian-win.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-unsigned --destination ../gitian.sigs/ ../testcoin/contrib/gitian-descriptors/gitian-osx.yml
...
then
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-win-signed --destination ../gitian.sigs/ ../testcoin/contrib/gitian-descriptors/gitian-win-signer.yml
	...
	then
	    ...
	    ./bin/gsign -p $signProg --signer $SIGNER --release ${VERSION}-osx-signed --destination ../gitian.sigs/ ../testcoin/contrib/gitian-descriptors/gitian-osx-signer.yml
