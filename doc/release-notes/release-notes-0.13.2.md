Testcoin Core version 0.13.2 is now available from:

  <https://testcoin.org/bin/testcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update testcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow testcoin-tx to create v2 transactions (ttcdrak)
