...
# TestNode: A peer we use to send messages to testcoind, and store responses.
...
class CompactBlocksTest(TestcoinTestFramework):
    ...
    # This test actually causes testcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that testcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for testcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # testcoind will not send blocktxn responses for blocks whose height is
