...
class BIP66Test(TestcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # testcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and testcoind produces more specific reject
            # reasons.
