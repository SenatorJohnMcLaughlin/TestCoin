...
#ifndef TESTCOIN_WALLET_WALLET_H
#define TESTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this testcoin node, and set to 0 for transactions that were created
...
#endif // TESTCOIN_WALLET_WALLET_H
