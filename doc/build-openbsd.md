...
This guide describes how to build testcoind and command-line utilities on OpenBSD.
...
The default C++ compiler that comes with OpenBSD 6.2 is g++ 4.2.1. This version is old (from 2007), and is not able to compile the current version of Testcoin Core because it has no C++11 support. We'll install a newer version of GCC:
...
at least with GCC 4.9.4 (see issue [#6658](https://github.com/testcoin/testcoin/issues/6658)).
