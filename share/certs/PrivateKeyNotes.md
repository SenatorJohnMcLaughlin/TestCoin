...
unlocked to sign the Testcoin-Qt.app bundle.
...
allowing somebody to distribute a Testcoin-Qt.app or testcoin-qt-setup.exe with a valid
...
that the testcoin-qt.exe file inside the installer had not been tampered with.
